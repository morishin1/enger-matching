          ...
          <div style={{ width: "100%", maxWidth: 380 }}>
            ...
            <form action={action} style={{ background: "rgba(255,255,255,.97)", borderRadius: 18, padding: 30, display: "flex", flexDirection: "column", gap: 13, boxShadow: "0 24px 70px rgba(0,0,0,.35)", backdropFilter: "blur(6px)" }}>
              ...
              <a
                ...
                aria-disabled={!agree}
                style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, padding: "11px", border: "1px solid #d6dce5", borderRadius: 10, background: "#fff", color: "#3c4043", fontSize: 14, fontWeight: 600, textDecoration: "none", opacity: agree ? 1 : 0.55, cursor: agree ? "pointer" : "not-allowed" }}
              >
              ...
              {needAgree && <div style={{ fontSize: 12, color: "#d23f57" }}>利用規約・プライバシーポリシーへの同意が必要です。</div>}
