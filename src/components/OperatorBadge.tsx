...
export function OperatorBadge({ operators = [], defaultName = "" }: { operators?: string[]; defaultName?: string }) {
  ...
  return (
    <div ref={ref} style={{ position: "relative" }}>
      ...
      {open && (
        <div style={{ position: "absolute", bottom: "calc(100% + 6px)", left: 0, right: 0, background: "var(--color-surface)", border: "1px solid var(--color-border-strong)", borderRadius: 12, boxShadow: "0 14px 40px rgba(0,0,0,.16)", padding: 6, maxHeight: 260, overflowY: "auto", zIndex: 50 }}>
