...
export function OperatorBadge({ defaultName = "", email = "", compact = false, role = "admin" }: { operators?: string[]; defaultName?: string; email?: string; compact?: boolean; role?: "admin" | "agent" | "client" | "candidate" }) {
